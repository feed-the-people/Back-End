...
user1.recipes.create!(
  ...
  instructions: "1. Make stir-fry sauce. Your sauce melds together all the different flavors and textures of the protein and vegetables in the stir-fry. For this recipe, the sauce is sweet and tangy. In a small bowl, combine cornstarch, orange juice, soy sauce, garlic and ginger until smooth; set aside. 2. Sear the meat. The meat or protein cooks first, seasoning the fat in the skillet. In a large skillet or wok, stir-fry pork in oil until lightly browned, 5 minutes; drain. 3. Toss in veggies. Whatever veggies you’re using go in next. Whatever you’re using, make sure to cut everything to the same size. Here, add the onion, peas and red pepper; cook and stir until crisp-tender, 3-5 minutes. 4. Add sauce. Cooking the sauce for a few minutes allows it to thicken up. Stir orange juice mixture and add to the pan. Bring to a boil; cook and stir until thickened, about 2 minutes. 5. Serve with carb of choice. Stir-fries are so full of flavor, they’re usually served on top of a plain base, which absorbs flavor from the sauce. We like to serve this with rice, rice noodles, zoodles or steamed vegetables.",
  charity_id: '4593516',
...
user2.recipes.create!(
  ...
  instructions: "1. In a large bowl, whisk together mayonnaise, sour cream, lime juice, honey, salt and pepper. Add coleslaw mix or shredded cabbage and gently toss to coat. Cover and refrigerate for at least 30 minutes, or up to 8 hours. 2. In a shallow dish, combine flour, taco seasoning, salt and pepper. Add the tilapia and lightly coat on both sides. Heat oil in a large skillet over medium-high heat. Shake excess flour off of the tilapia and place in the skillet. Brown fish on both sides (about 2-3 minutes per side). Flake into large chunks. 3. Toast the corn tortillas in a dry skillet over medium heat for about 30 seconds per side. Alternatively, you can wrap the tortillas in stacks of five in foil and warm in a 350°F oven for 10-15 minutes (or until heated through). 4. Fill each warm tortilla with flaked tilapia, slaw and other toppings of choice.",
  charity_id: '0545998',
...
user3.recipes.create!(
  ...
  instructions: "1. Pour the eggs, onion, garlic, water, breadcrumbs, Parmesan and seasonings into a large bowl. Whisk it well until all of the ingredients are evenly dispersed. The eggs and breadcrumbs are essential for binding the meat. Thanks to their moisture content, eggs help keep your meatballs lovely and tender. 2. Crumble the ground beef into the egg mixture. Use your hands to combine everything but do not overwork the beef. I can’t stress this enough! If you overdo it, you run the risk of tough meatballs. Instead, gently work the mix until it’s just combined. Once you’re happy with the beef mixture, lightly shape the meatballs to be about 1 to 1 ½ inches. You can make larger meatballs, if you choose. 3. Grease a rack and place it in a shallow baking tray. I pour a little olive oil onto a paper towel and rub the rack down, but a nonstick cooking spray would work here. Arrange the meatballs, and then put them in the oven. Bake at 375° for about 15 to 18 minutes, or until your instant-read thermometer says they’re cooked through (160-165°).",
  charity_id: '6048381',
...
user4.recipes.create!(
  ...
  instructions: '1. Cook linguine according to package directions, adding peas during the last 3 minutes. Meanwhile, in a large cast-iron or other heavy skillet, saute garlic, Italian seasoning and pepper in oil until garlic is tender, about 1 minute. Stir in prosciutto. 2. Drain linguine; add to skillet and toss to coat. Sprinkle with cheese.',
  charity_id: '0620048',
...
user7.recipes.create!(
  ...
  instructions: "Heat the oil in pot over medium heat. Then add the onions and then sautée until slightly brown, about 7-10 minutes. Add the ginger-garlic paste and sautée about 1 minute. Add the cumin and salt and sautee about 1 minute. Add lentils, carrots, potatoes, and chicken broth. Bring to boil and then turn down to a rolling simmer. Simmer for 25 minutes, until vegetables are soft. Take one cup of the soup and emulsify it in a blender. Mix the blended cup back in the pot. Add lemon juice to the pot. Cook for another 5 mins. Add the parsley right before you serve.",
  charity_id: '123123',
...
user8.recipes.create!(
  ...
  instructions: 'To shred the Napa cabbage, use a food processor or high speed blender and pulse. In a bowl, combine all of the ingredients except the wrappers. Take a dumpling wrapper and place a spoonful of filling in the center, about a teaspoons worth. Dip your finger in the bowl of water and spread it around the edges of the wrapper. Fold the wrapper in half and pinch the sides together to create a seal. Place the finished dumplings on a floured surface or on parchment paper so they don’t stick. Bring a pot of water to boil. Boil the dumplings until they float–this means they’re done. If desired, heat the sesame oil on high and quickly pan fry the dumplings after boiling for extra flavor and a little more texture. Serve hot with a drizzle of soy sauce and sprinkle of green onions.',
  charity_id: '84734',
  charity_name: 'AARP',
  avg_rating: 5.0
)
